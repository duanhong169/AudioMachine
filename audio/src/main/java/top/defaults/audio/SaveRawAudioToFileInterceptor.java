...
class SaveRawAudioToFileInterceptor extends AudioInterceptor.RawAudioInterceptor<Bundle> {
    ...
    public void onAudio(@NonNull final byte[] buffer, boolean end) {
        ...
        Future<Integer> future = executorService.submit(() -> fileWriter.appendData(buffer));
